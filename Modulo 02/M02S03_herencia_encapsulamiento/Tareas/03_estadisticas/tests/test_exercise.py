...
def test_excercise(test_data):
    ...
    def mock_input(input_s=None):
        ...
        # return value.pop(0)
    src.estadisticas.input = mock_input
    src.estadisticas.print = lambda *args: output.append(" ".join(map(str, args)))
