...
def test_excercise(test_data):
    ...
    def mock_input(input_s=None):
        ...
        # return value.pop(0)
    src.operaciones.input = mock_input
    src.operaciones.print = lambda *args: output.append(" ".join(map(str, args)))
